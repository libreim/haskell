...
\note{
El espacio de nombres de las variables es independiente en cada declaración de tipo.
La clase de tipo \texttt{Ord} incluye tipos con relaciones de orden definidas.
}
